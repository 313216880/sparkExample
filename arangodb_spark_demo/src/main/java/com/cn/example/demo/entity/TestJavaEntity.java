...
public class TestJavaEntity  implements Serializable {
	...
	public String toString() {
		return "TestJavaEntity [test=" + test + ", booleanValue=" + booleanValue + ", doubleValue=" + doubleValue
				+ ", floatValue=" + floatValue + ", longValue=" + longValue + ", intValue=" + intValue + ", shortValue="
